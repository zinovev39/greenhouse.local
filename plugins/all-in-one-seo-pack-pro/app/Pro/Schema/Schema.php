...
class Schema extends CommonSchema\Schema {
	 ...
	 */
	protected function generateSchema( $graphs = [], $customGraphs = [], $defaultGraph = null, $blockGraphs = [], $isValidator = false ) {
		...
		$schema = [
			...
			'@graph'   => $this->getUserDefinedGraphs( $graphs, $customGraphs, $defaultGraph )
		];
	...
	public function getValidatorOutput( $postId, $graphs = [], $customGraphs = [], $defaultGraph = null, $blockGraphs = [] ) {
		...
		$output = $this->generateSchema( $graphs, $customGraphs, $defaultGraph, $blockGraphs, true );
